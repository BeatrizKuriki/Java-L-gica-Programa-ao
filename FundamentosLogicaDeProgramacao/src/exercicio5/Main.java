...
public class Main {
	...
	public static void main(String[] args) {
		...
		/**
		 * System.out.println("Digite o código da peça 1"); codPc1 = sc.nextInt();
		 * System.out.println("Digite a quantidade de peças 1"); qtdPc1 = sc.nextInt();
		 * System.out.println("Qual o valor da peça 1?"); valorPc1 = sc.nextDouble();
		 * System.out.println("Digite o código da peça 2"); codPc2 = sc.nextInt();
		 * System.out.println("Digite a quantidade de peças 2"); qtdPc2 = sc.nextInt();
		 * System.out.println("Qual o valor da peça 2?"); valorPc2 = sc.nextDouble();
		 * 
		 * double totalPc1 = qtdPc1 * valorPc1; double totalPc2 = qtdPc2 * valorPc2; int
		 * qtdTotal = qtdPc1 + qtdPc2; double valorTotal = totalPc1 + totalPc2;
		 * 
		 * 
		 * 
